...
c5 = Category.create(category_name: "", cat_type: "Necessary")

c6 = Category.create(category_name: "Investment", cat_type: "Savings")
c7 = Category.create(category_name: "Deposit", cat_type: "Savings")
c8 = Category.create(category_name: "", cat_type: "Savings")
c9 = Category.create(category_name: "Deposit", cat_type: "Savings")
